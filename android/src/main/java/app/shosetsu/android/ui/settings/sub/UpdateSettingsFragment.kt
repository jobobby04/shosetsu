...
fun UpdateSettingsView(
	...
	val viewModel: AUpdateSettingsViewModel = viewModelDi()

	UpdateSettingsContent(viewModel, onBack)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun UpdateSettingsContent(viewModel: AUpdateSettingsViewModel, onBack: () -> Unit) {
	Scaffold(
		topBar = {
			TopAppBar(
				title = {
