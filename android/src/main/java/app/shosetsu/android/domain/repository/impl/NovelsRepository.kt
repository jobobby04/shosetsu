...
class NovelsRepository(
	...
	): List<Novel.Info> = onIO { remoteCatalogueDataSource.search(ext, query, data, search) }
	...
	): List<Novel.Info> = onIO { remoteCatalogueDataSource.loadListing(ext, data, listing) }
